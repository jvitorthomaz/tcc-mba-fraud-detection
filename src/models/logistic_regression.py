...
# TUNING (UMA VEZ)
# ==============================
def tune_model(df_train, df_val):
...
# MAIN TEMPORAL
# ==============================
def run_logistic_regression(df_train, df_val, df_test):
    ...
    best_models = tune_model(df_train_init, df_val_init)
    ...
    results_df.to_csv("results/logistic_regression_results.csv")
